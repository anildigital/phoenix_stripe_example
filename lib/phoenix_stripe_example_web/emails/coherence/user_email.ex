...
defmodule PhoenixStripeExampleWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: PhoenixStripeExampleWeb.Coherence.EmailView, layout: {PhoenixStripeExampleWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
